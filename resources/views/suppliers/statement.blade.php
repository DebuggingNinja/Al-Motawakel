            ...
            <div class="userDatatable global-shadow border-light-0 w-100" id="pdf-content">
              <div class="my-3">
                <table class="table mb-0 table-borderless horizontal-table ">
                  ...
                  <tr>
                    <td colspan="2">
                      <form method="post" action="{{route('suppliers.statement.update_dollar_rate')}}">
                        @csrf
  ...
  <script>
    $(document).ready(function(){
      ...
      account.change(function () {
        if(!$(this).val()) return;
        window.location = "{{route('suppliers.statement', request()->id)}}?account=" + $(this).val();
      });
      $(".close-account").click(function () {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location = "{{route('suppliers.statement.restart_account', $supplier->id)}}";
          }
        });
      });
    });
